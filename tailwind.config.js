  ...
  theme: {
    ...
    colors: {
     ...
     fontFamily: {
      ...
      screens: {
      'xs': { 'min': '320px', 'max': '479px' }, // very small phones
      'sm-mobile': { 'min': '480px', 'max': '575px' }, // small–medium phones
      'md-mobile': { 'min': '576px', 'max': '767px' }, // larger phones
      'tablet': { 'min': '768px', 'max': '1023px' }, // tablets
      // keep Tailwind defaults if needed
      'sm': '640px',
      'md': '768px',
      'lg': '1024px',
      'xl': '1280px',
