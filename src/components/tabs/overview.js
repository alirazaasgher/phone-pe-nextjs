    ...
    <>
      {activeTab === "overview" && (
        <div className="space-y-10">
          <div
            className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-16 relative z-10">
              {/* Pros */}
              <div
                className="bg-gradient-to-br from-emerald-900/40 to-teal-900/40 backdrop-blur-sm
              ...
              {/* Cons */}
              <div
                className="bg-gradient-to-br from-rose-900/40 to-pink-900/40 backdrop-blur-sm
